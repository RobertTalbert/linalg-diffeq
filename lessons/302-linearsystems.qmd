...
Example of a consistent system with one solution: 
...
## RREF gives you complete information about solutions

A quick glance at the RREF of a system's augmented matrix tells you whether or not a system is consistent; and if it's consistent, how many solutions it has. 
...
- So don't stress over doing RREF by hand, just practice until you do it on simple systems without a bunch of mistakes. $\rightarrow$ **Optional RREF Practice set on WeBWorK** 